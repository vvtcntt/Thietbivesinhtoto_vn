...
namespace TOTO.Controllers.Display.Session.ProductSale
{
    public class SaleController : Controller
    {
        ...
        {
            ViewBag.Title = "<title> Cập nhật chương trình khuyến mại Thiết bị vệ sinh TOTO chính hãng</title>";
            ViewBag.Description = "<meta name=\"description\" content=\"Sau đây là những Cập nhật chương trình khuyến mại Thiết bị vệ sinh TOTO chính hãng do trung tâm phân phối sản phẩm TOTO gửi tới quý khách hàng\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"khuyên mại inax, thiết bị vệ sinh TOTO khuyến mại\" /> ";
